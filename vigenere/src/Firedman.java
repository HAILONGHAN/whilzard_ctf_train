...
public class Firedman {
    // Friedman测试法确定密钥长度
    public  int Friedman3(String ciphertext) {
    ...
    public static void main(String[] args) {
        String test = "";

        Firedman my = new Firedman();
        my.decryptCipher(6,test);
        my.decryptCipher(15,test);
